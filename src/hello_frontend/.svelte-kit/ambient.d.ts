...
declare module '$env/static/private' {
	...
	export const CANISTER_ID_HELLO_FRONTEND: string;
	export const npm_config_global_prefix: string;
	export const COLOR: string;
	export const CANISTER_ID_HELLO_BACKEND: string;
	...
	export const CANISTER_CANDID_PATH_HELLO_BACKEND: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		TERM: string;
		SHELL: string;
		CANISTER_ID_HELLO_FRONTEND: string;
		npm_config_global_prefix: string;
		COLOR: string;
		CANISTER_ID_HELLO_BACKEND: string;
		...
		SUDO_COMMAND: string;
		HOME: string;
		CANISTER_CANDID_PATH_HELLO_BACKEND: string;
