...
export const canisterId = process.env.CANISTER_ID_HELLO_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hello_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hello_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hello_frontend.did.js")._SERVICE>}
 */
